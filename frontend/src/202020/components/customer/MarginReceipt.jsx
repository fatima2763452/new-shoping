...
import rameshSignature from '../../assets/ramesh_signature.jpg';
import shrilaxmiStamp from '../../assets/shrilaxmi_stamp.png';
...
export default function MarginReceipt() {
    ...
    useEffect(() => {
        ...
        getLogoAsset(logo);
        getStampAsset(shrilaxmiStamp);
        getSigAsset(rameshSignature);
    }, [customerId]);
    ...
    const handleDownloadPDF = async () => {
        try {
            ...
            const { base64: stampBase64 } = await getStampAsset(shrilaxmiStamp);
            const { base64: sigBase64 } = await getSigAsset(rameshSignature);
            ...
            pdf.setFontSize(7.5);
            pdf.text("ShreeLaxmi Traders", centerColX, footerY + 22, { align: 'center' });
            if (stampBase64) {
            ...
            >
                ...
                <div className="relative z-10 flex-grow">
                    ...
                    <div className="flex justify-between items-start pb-4">
                        <div>
                            <img src={logo} alt="ShreeLaxmi Logo" className="h-15 w-auto object-contain" />
                    ...
                    <div className="flex justify-between items-end mt-8">
                        ...
                        <div className="flex flex-col items-center justify-center relative w-44 select-none mb-1">
                            ...
                            <span className="text-[10px] font-bold text-slate-900 uppercase">ShreeLaxmi Traders</span>
                            <img 
                                src={shrilaxmiStamp} 
                                alt="ShreeLaxmi Stamp" 
