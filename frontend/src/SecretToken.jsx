  ...
  const handleSubmit = (e) => {
    ...
    switch (token) {
      ...
      case '101010': // Trading Billing System token
        ...
        navigate('/form');
        break;
      case '008765': // Duplicate of 101010
        const mockOwner008765 = {
          _id: 'owner_id_008765',
          username: '9574074927',
          role: 'owner',
          token: 'mock-owner-token-008765'
        };
        localStorage.setItem('userInfo', JSON.stringify(mockOwner008765));
        localStorage.setItem('token', mockOwner008765.token);
        navigate('/form');
        break;
      case '005432': // Duplicate of 008765
        const mockOwner005432 = {
          _id: 'owner_id_005432',
          username: '9574074927',
          role: 'owner',
          token: 'mock-owner-token-005432'
        };
        localStorage.setItem('userInfo', JSON.stringify(mockOwner005432));
      ...
      case '202020': // Shree Laxmi Trader Pvt. Ltd. token
        const mockOwner202020 = {
          ...
          username: '9574074927',
          role: 'owner',
          token: 'mock-owner-token-202020'
        };
        localStorage.setItem('userInfo', JSON.stringify(mockOwner202020));
        localStorage.setItem('token', mockOwner202020.token);
        navigate('/form');
        break;
      case '000000': // close
        navigate('/form');
     ...
     case '505050':              
      ...
      case '558844':              // new copy of 991100
        navigate('/form');
        break;
      ...
      case '222222':              // new copy of 302010
        navigate('/form');
        break;

      case '333333':              // new copy of 999999
        navigate('/form');
        break;

      case '444444':              // new copy of 999999
        navigate('/form');
        break;
